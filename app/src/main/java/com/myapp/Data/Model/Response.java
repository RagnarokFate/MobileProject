...
public class Response {
    ...
    public Response(int request_id, int user_request_id, String username, Object data_received, Object data_sent, Object message, String message_content) {
    ...
    public Response(int request_id, String message_content) {
        this.request_id = request_id;
        this.message_content = message_content;
    }
